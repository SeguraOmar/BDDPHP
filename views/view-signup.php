...
<body>
    ...
    <form action="controller-signup.php" method="POST" novalidate>
        ...
        <input type="text" id="firstname" name="firstname" value="<?= isset($_POST['firstname']) ? htmlspecialchars($_POST['firstname']) : '' ?>">
        <span class="error">
        ...
        <input type="text" id="lastname" name="lastname" value="<?= isset($_POST['lastname']) ? htmlspecialchars($_POST['lastname']) : '' ?>">
        <span class="error">
        ...
        <input type="text" id="pseudo" name="pseudo" value="<?= isset($_POST['pseudo']) ? htmlspecialchars($_POST['pseudo']) : '' ?>">
        <span class="error">
        ...
        <input type="password" id="password" name="password" value="<?= isset($_POST['passsword']) ? htmlspecialchars($_POST['password']) : '' ?>">
        <span class="error">
